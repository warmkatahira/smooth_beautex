...
class AutoProcessUpdateRequest extends BaseRequest
{
    /**
    ...
    public function rules(): array
    {
        // 共通ルール
        $rules = [
            'auto_process_name'     => 'required|string|max:30|unique:auto_processes,auto_process_name,'.$this->auto_process_id.',auto_process_id',
