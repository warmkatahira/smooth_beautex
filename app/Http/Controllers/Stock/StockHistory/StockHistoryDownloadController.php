...
class StockHistoryDownloadController extends Controller
{
    public function download()
    {
        ...
        $response->headers->set('Content-Disposition', 'attachment; filename=【'.SystemEnum::CUSTOMER_NAME_JP.'様】在庫履歴データ_' . CarbonImmutable::now()->isoFormat('Y年MM月DD日HH時mm分ss秒') . '.csv');
        return $response;
    }
}
