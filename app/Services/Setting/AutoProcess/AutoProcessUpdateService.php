...
class AutoProcessUpdateService
{
    // 自動処理を更新
    public function updateAutoProcess($request)
    {
        // 自動処理を取得
        $auto_process = AutoProcess::getSpecify($request->auto_process_id)->lockForUpdate()->first();
        // 自動処理受注商品を削除
