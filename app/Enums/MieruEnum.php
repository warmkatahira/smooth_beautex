...
{
    // 項目を定義
    const SHIPMENT_SHIPPING_QUANTITY                           = "shipment_shipping_quantity";
    ...
    const INSPECTION_INCOMPLETE_SHIPMENT_SHIPPING_QUANTITY     = "inspection_incomplete_shipment_shipping_quantity";
