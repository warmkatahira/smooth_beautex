        ...
        @foreach($orders as $order)
            ...
            <div style="{{ $order_count != 1 ? 'page-break-before: always; padding-top: 0mm;' : '' }}">
                ...
                <div class="my-3 flex flex-row flex-wrap">
                    ...
                    <x-shipping.kobetsu-picking-list.info-div label="受注区分" :value="$order->order_category->order_category_name" />
                    <x-shipping.kobetsu-picking-list.info-div label="モール" :value="$order->order_category->mall->mall_name" />
